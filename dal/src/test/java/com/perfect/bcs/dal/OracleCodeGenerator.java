...
//广东妇幼
//    private static String ipPort = "115.29.162.41:1521";
//    private static String dbName = "ORCLCDB";
//    private static String dbUserName = "C##JHEMR";
//    private static String dbPassword = "qq9eEr6hJtp9MZw";
//玉林二院
    private static String ipPort = "127.0.0.1:1521";
    private static String dbName = "ORCL";
    private static String dbUserName = "drg";
    private static String dbPassword = "123456";

    // 配置代码生成路径
    private static String sourceCodePath = "D:/td1234";
    // 修改包的路径
    private static String packagePath = "oracle";
    ...
    public static void main(String[] args) {
        ...
        // 配置代码生成路径
        gc.setOutputDir(sourceCodePath);
        ...
        String dbUrl = StrUtil.format("jdbc:oracle:thin:@{}:{}", ipPort, dbName);
        dsc.setUrl(dbUrl);
